...
import { Plus, Minus, Calendar, Flame, Receipt, PiggyBank } from 'lucide-react';
import { AppContext } from '../context/AppContext';
import SavingsOverlay from './SavingsOverlay';

// Componente Batteria Realistica
...
const Dashboard = () => {
  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <motion.button
            ...
            style={{
              ...
              justifyContent: 'center',
              cursor: 'pointer',
              boxShadow: '0 4px 15px rgba(76, 111, 255, 0.25)',
            }}
          >
      ...
      >
        ...
        <motion.p
          ...
          style={{
            ...
            marginBottom: '8px',
            textShadow: budgetSurplus >= 0 ? '0 0 10px rgba(46, 204, 113, 0.3)' : '0 0 10px rgba(255, 82, 82, 0.3)'
          }}
        >
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              <div style={{
                ...
                height: '40px',
                borderRadius: '12px',
                background: `rgba(251, 183, 77, 0.15)`,
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
              }}>
      ...
      {/* MODIFICA QUI: Pulsanti di azione in fondo alla pagina */}
      <div style={{ 
        margin: '30px 16px 140px', // Margine in fondo molto grande
        maxWidth: '428px',
        marginLeft: 'auto',
        marginRight: 'auto'
      }}>
                  ...
                  <div style={{
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: 'none',
                        borderRadius: '8px',
                        color: newTransaction.amount && parseFloat(newTransaction.amount) > 0 ? 'white' : theme.textSecondary,
                        fontSize: '16px',
                        fontWeight: '600',
