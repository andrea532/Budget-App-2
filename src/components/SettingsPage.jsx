    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {/* Pulsante per resettare il database */}
          <motion.div
            variants={itemVariants}
            whileTap={{ scale: 0.98 }}
          ...
          >
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <p style={{ fontWeight: '500', color: theme.danger }}>
                    Reset database
                  </p>
                  <p style={{ fontSize: '14px', color: theme.textSecondary }}>
              ...
              <ChevronRight size={20} style={{ color: theme.danger }} />
            </div>
          </motion.div>
        </div>
      </motion.div>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                Questa operazione cancellerà tutti i dati salvati nell'app. L'operazione non può essere annullata.
              </p>
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    padding: '12px',
                    borderRadius: '12px',
                    background: `linear-gradient(135deg, ${theme.danger} 0%, #ff3333 100%)`,
                    color: 'white',
                    fontWeight: '600',
                    border: 'none',
                    cursor: 'pointer',
